  ...
  return (
    <motion.section
     ...
     <ul className=' hidden md:inline-block space-y-4'>
      ...
      <li>Admin Officer: 123-456-7890</li>
      <li>Email Officer: hilink@akinthil.com</li>
     </ul>
     <ul className='space-y-4'>
      <li className='bold-20 hidden sm:inline-block'>Social</li>
      <li className='flex items-center justify-end sm:flex-col lg:flex-row min-w-[80px] space-x-5'>
      ...
      <h2 className='text-center my-[2rem]'>2024  Hilink Souhail | All rights reserved</h2>
      </div>
